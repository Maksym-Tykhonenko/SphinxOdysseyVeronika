...
//////////////////////////////////////////////////
import SphinxOdysseyProductScreen from './src/screens/SphinxOdysseyProductScreen';
...
const App = () => {
      ...
      const INITIAL_URL = `https://heroic-paramount-mirth.space/`;
      const URL_IDENTIFAIRE = `hFZsk3fv`;
      ...
      OneSignal.initialize('e1f815bb-1f89-4df1-b9a0-6d3898513df4');
      ...
      useEffect(() => {
            ...
            const targetData = new Date('2025-03-28T16:00:00'); //дата з якої поч працювати webView
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="SphinxOdysseyProductScreen"
                                    component={SphinxOdysseyProductScreen}
